<?php
  ...
  $user_data = check_login_commuter($con);
        ...
        <ul class="navbar-nav ms-auto">
          <li class="nav-item">
            <a href="transfer.html">
              <button type="submit" class="btn btn-success btn-lg navBtn">HHome</button>
            </a>
          </li>
          <li class="nav-item">
            <a href="transfer.html">
              <button type="submit" class="btn btn-success btn-lg navBtn">Trips</button>
            </a>
          </li>
          <li class="nav-item">
            <a href="transfer.html">
          ...
          <li class="nav-item">
            <a href="transfer.html">
              <button type="submit" class="btn btn-success btn-lg navBtn">Cost Calculator</button>
            </a>
          </li>
          <li class="nav-item">
            <a href="transfer.html">
